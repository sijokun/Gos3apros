...
async def check(ip: str, tid: str, useragent: str, url: str):
    ...
    if check_ip:
        ...
        async with session_scope() as session:
            ...
            query = select(models.Notification.chat_id).where(models.Notification.enable)
...
if __name__ == "__main__":
    os.system("uvicorn main:app --host 0.0.0.0 --proxy-headers --forwarded-allow-ips='*'")
